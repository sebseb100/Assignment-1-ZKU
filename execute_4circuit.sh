...
snarkjs groth16 setup merklecircuit.r1cs pot12_final.ptau merklecircuit_8inputs_0000.zkey

snarkjs zkey contribute merklecircuit_0000.zkey merklecircuit_8inputs_0001.zkey --name="1st Contributor Name" -v
